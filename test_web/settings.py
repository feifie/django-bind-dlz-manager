...
DATABASE_ROUTERS = ['test_web.router.DatabaseAppsRouter']
# DATABASE_APPS_MAPPING = {'django_bind_dlz_manager': 'postgresql'}
# DATABASE_APPS_MAPPING = {'django_bind_dlz_manager': 'mysql'}
